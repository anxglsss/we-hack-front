...
export default function DashboardLayout({ 
  ...
  return (
    <div className="relative flex min-h-screen bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-900 overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 translate-x-1/3 -translate-y-1/3 w-[500px] h-[500px] bg-gradient-to-br from-blue-500 via-cyan-400 to-indigo-600 rounded-full blur-3xl opacity-30 z-0 pointer-events-none" />
      {/* Content */}
      <Sidebar />
